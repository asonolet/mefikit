...
- unify the Rust `TransferOperator` as a single struct with new backend dispatch, replacing the previous per-backend operator types ([#37](https://github.com/asonolet/mefikit/pull/37))

### Add

- `from_medcoupling`: build a `UMesh` directly from MEDCoupling objects

### Documentation

- mefikit vs medcoupling comparison notebook ([#38](https://github.com/asonolet/mefikit/pull/38))

## [0.3.2](https://github.com/asonolet/mefikit/compare/v0.3.1...v0.3.2) - 2026-09-11

### Fix

- `med_io`: fix MED file reading and writing

## [0.3.1](https://github.com/asonolet/mefikit/compare/v0.3.0...v0.3.1) - 2026-09-06

### Fix

- remove faulty `publish = false` on `mefipy` (it is not published anyway)

### Other

- set up and fix the release process so all packages share one tag
