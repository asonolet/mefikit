...
- release v0.3.2 ([#36](https://github.com/asonolet/mefikit/pull/36))
- release v0.3.1
...
- unify rust TransferOperator as a single struct with new dispatch ([#37](https://github.com/asonolet/mefikit/pull/37))
